...
assert.match(launcher, /function Test-IsAdministrator/);
assert.match(launcher, /\$installerStartParameters\.Verb = 'RunAs'/);
assert.match(launcher, /Start-Process @installerStartParameters/);
assert.match(launcher, /Codex RTL rebuild requires administrator approval/);
